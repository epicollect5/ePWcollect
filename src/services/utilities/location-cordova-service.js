...
export const locationService = {
    ...
    getWatchTimeout () {
        ...
        console.log('TIMEOUT for location should be (ms)->', timeout);
        return timeout;
    },
    ...
    startWatching () {
        ...
        async function _triggerStartWatching () {
            ...
            function geolocationSuccess (position, error) {
    ...
    stopWatching () {
        ...
        if (rootStore.geolocationPermission) {
            navigator.geolocation.clearWatch(rootStore.deviceGeolocation.watchId);
        }
    }
};
